export const menuButtonsConfig = {
  ...
  externalAdReply: {
    ...
    sourceUrl: 'https://github.com/VENOM-X/VENOM-X',
    mediaType: 1,
...
export const buttonResponses = {
  repo_main: {
    ...
    url: "https://github.com/VENOM-X/VENOM-X"
  },

  repo_web: {
    text: "🌐 *Web Dashboard*\n\n🔗 Dashboard: https://VENOM-X-deploy.onrender.com\n📊 Monitor your bot's performance\n⚙️ Configure settings remotely",
    url: "https://VENOM-X-deploy.onrender.com"
  },

  creator_contact: {
    text: "👨‍💻 *Creator Contact*\n\n📱 WhatsApp: +2349122222622\n🐙 GitHub: @VENOM-X\n💬 Telegram: @VENOM-X\n📧 Email: VENOM-X@gmail.com",
    contact: {
      phone: "+2349122222622",
      name: "Davex-254 MD - Bot Creator"
    }
  },
  ...
  contact_support: {
    text: "🌐 *Contact Support*\n\n📞 Support Website: www.Davex-254-support.zone.id\n💬 Telegram: t.me/VENOM-X\n📱 WhatsApp Channel: https://whatsapp.com/channel/0029VaIiMsqJf05e4Y4b9u0z\n🔗 Get help and support now!",
    url: "http://www.Davex-254-support.zone.id"
  }
};
