  ...
  async execute(msg, { sock, args }) {
    ...
    try {
      ...
      const [userResponse, reposResponse] = await Promise.all([
        axios.get(`https://api.github.com/users/${username}`, { timeout: 10000, headers: { 'User-Agent': 'VENOM-X' } }),
        axios.get(`https://api.github.com/users/${username}/repos?per_page=100&sort=updated`, { timeout: 10000, headers: { 'User-Agent': 'VENOM-X' } })
      ]);
